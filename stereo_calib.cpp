...
static int print_help()
{
    ...
    cout << "Usage:\n ./stereo_calib -w=<board_width default=9> -h=<board_height default=6> -s=<square_size default=1.0 in meter> <image list XML/YML file default=../data/stereo_calib.xml>\n" << endl;
    return 0;
}
